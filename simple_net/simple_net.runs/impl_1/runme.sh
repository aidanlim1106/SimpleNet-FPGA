...
HD_PWD='C:/FPGA_Projects/Simple_Net/simple_net/simple_net.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_clk_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_clk_test.tcl -notrace
