...
HD_PWD='C:/FPGA_Projects/Simple_Net/simple_net/simple_net.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_clk_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_clk_test.tcl
