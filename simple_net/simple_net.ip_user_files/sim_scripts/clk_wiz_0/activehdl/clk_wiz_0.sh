...
#
# Script generated by Vivado on Sat Mar 21 20:17:51 -0400 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/FPGA_Projects/Simple_Net/simple_net/simple_net.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
